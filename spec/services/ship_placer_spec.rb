require 'spec_helper'
require './app/services/ship_placer_service'
require './app/services/values/board_service'
require './app/services/values/space_service'
...
describe ShipPlacerService do
  ...
  xit "exists when provided a board and ship" do
